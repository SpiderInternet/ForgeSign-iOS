...
// تعريف نوع ملف IPA و P12 و MobileProvision بشكل دقيق لضمان إمكانية اختيارها في تطبيق الملفات
extension UTType {
    static var ipa: UTType {
        UTType(filenameExtension: "ipa") ?? UTType(exportedAs: "com.apple.itunes.ipa")
    }
...
struct CertificatesSheet: View {
    ...
    var body: some View {
        NavigationStack {
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("قم بإضافة شهادة (.p12) وملف التعريف (.mobileprovision) لبدء توقيع التطبيقات.")
                    ...
                    // 3. عرض الحالة والشهادات الحالية إن وجدت
            ...
            // التنبيه لإدخال كلمة سر الـ P12
